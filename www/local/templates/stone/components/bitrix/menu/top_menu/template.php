...
?>
<div class="bx-top-nav bx-<?=$arParams["MENU_THEME"]?> header__menu-second-wrap" id="<?=$menuBlockId?>">
	<nav class="bx-top-nav-container header__main-menu main-menu" id="cont_<?=$menuBlockId?>">
		<ul class="bx-nav-list-1-lvl main-menu__list" id="ul_<?=$menuBlockId?>">
		<?
		...
		?>
			<li
				class="<?=$class?> main-menu__item" data-drop-linc=""
			...
			>
				<a
					class="bx-nav-1-lvl-link main-menu__linc" data-drop-linc=""
				...
				?>
					...
					<div class="bx-nav-2-lvl-container">
						...
						{
						?>
							<ul class="bx-nav-list-2-lvl main-menu__drop-list" data-drop-menu="">
							<?foreach($arRow as $itemIdLevel_2=>$arLevel_3):?>  <!-- second level-->
								<li class="bx-nav-2-lvl main-menu__drop-item">
									<a class="bx-nav-2-lvl-link main-menu__drop-linc"
		...
		<label class="header__second">
							<svg class="header__second-icon">
								<use xlink:href="/local/templates/stone/images/sprite.svg#icon-search"></use>
							</svg>
							<input class="input input_contact header__second-input" type="search" name="search" placeholder="Найти">
						</label>
						<button class="header__burger-button" data-burger-button><span></span></button>
</div>
